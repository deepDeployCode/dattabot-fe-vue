  ...
  methods: {
    ...
    async editRekomendasi() {
      ...
      this.$swal({
        ...
        text: "Data Rekomendasi Izin Praktik SPESIALIS yang di edit sudah sesuai dengan yang anda isi ",
        icon: "warning",
        ...
        .then((result) => {
          if (result.value) {
            ...
            return apis.rekomendasi.rekomendasiInput(editRekomSpesialis);
          }
          return false;
        })
        .then((result) => {
          if (result) {
            ...
            this.$toast({
              ...
              props: {
                title: "Berhasil edit rekomendasi SPESIALIS ",
                icon: "CheckIcon",
                variant: "success",
              },
            });
