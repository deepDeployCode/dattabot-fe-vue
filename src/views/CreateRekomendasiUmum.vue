    ...
    <div class="p-2 mx-auto">
      ...
      >
        ...
        >
          ...
          >
            <b-card
              v-if="rekomendasi.data.reksip_kompetensi_jenis && rekomendasi.data.reksip_kompetensi_no"
              footer-tag="footer"
          ...
          >
            ...
            >
              <table>
                <tr>
                  <td>Nomor STR</td>
                  <td><span class="ml-1 mr-1">:</span> <span>{{ rekomendasi.data.reksip_str_no }}</span></td>
                </tr>
                <tr>
                  <td>Berlaku Sampai</td>
                  <td><span class="ml-1 mr-1">:</span> <span>{{ rekomendasi.data.reksip_str_tgl_berakhir }}</span></td>
                </tr>
              </table>
              <b-img
          ...
          >
            ...
            >
              ...
              <p class="p-1">
                Catatan:
                Untuk anggota IDI Jakarta Pusat, silahkan unduh <a
                  class="link external"
                  href="https://drive.google.com/file/d/1HaxKWdxdu-4ZkWzA9iJG0J6CJG00EhCz/view"
                >formulir ini</a>, diisi dan unggah kembali.
              </p>
            </validation-provider>
          </b-form-group>
          <b-button
            ...
            block
            @click="$router.push('/rekomendasi/umum/pembayaran')"
          >
            Lanjutkan
          </b-button>
        </b-form>
        ...
        <b-modal
          id="modal-str"
          title="Pilih Surat Tanda Registrasi"
          hide-footer
        >
          <b-card
          ...
          >
            <table>
              <tr>
                <td>Nomor STR</td>
                <td><span class="ml-1 mr-1">:</span> <span>{{ item.str_no }}</span></td>
              </tr>
              <tr>
                <td>Berlaku Sampai</td>
                <td><span class="ml-1 mr-1">:</span> <span>{{ item.str_tgl_berakhir }}</span></td>
              </tr>
            </table>
