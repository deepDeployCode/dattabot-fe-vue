    ...
    <div class="p-2 mx-auto">
      <validation-observer
        ...
        <b-form class="mt-1" @submit.prevent>
          ...
          <p class="p-1">
            Catatan: Surat Rekomendasi dari IDI Cabang Selain Jakpus ATAU Pengantar dari IDI Cabang Asal, silahkan unduh
            <a
              class="link external"
              href="https://drive.google.com/file/d/1HaxKWdxdu-4ZkWzA9iJG0J6CJG00EhCz/view"
              >formulir ini</a
            >, diisi dan unggah kembali pada upload file surat rekomendasi cabang.
          </p>
          <b-form-group
...
export default {
  ...
  mounted() {},
  created() {
    this.fetchRekomendasiSpesialis();
  },
  methods: {
    ...
    async submitRekomendasi() {
      ...
      this.$swal({
        ...
        text: "Data Rekomendasi Izin Praktik SPESIALIS sudah sesuai dengan yang anda isi ",
        icon: "warning",
        ...
        .then((result) => {
          if (result.value) {
            ...
            return apis.rekomendasi.rekomendasiInput(submitRekomSpesialis);
          }
          return false;
        })
        .then((result) => {
          if (result) {
            ...
            this.$toast({
              ...
              props: {
                title: "Berhasil membuat rekomendasi SPESIALIS ",
                icon: "CheckIcon",
                variant: "success",
              },
            });
