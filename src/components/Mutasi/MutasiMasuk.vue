      ...
      >
        ...
        <div class="p-1">
          ...
          >
            ...
            Data dan berkas telah diterima oleh aplikasi dan notifikasi sudah diberikan kepada admin.
            <br>
            <br>
...
export default {
  ...
  computed: {
    isHidePengajuan() {
      return (this.user?.data?.orang_level === 'non-jakpus' && this.mutasi.data?.[0].mutmasuk_status === 'selesai-sukses')
    },
    isHowAddPengajuan() {
      return this.mutasi.data?.[0] && this.mutasi.data?.[0].mutmasuk_status !== 'diajukan' && this.user?.data?.orang_level === 'non-jakpus'
    },
    fileIuranAsal() {
      return item => {
