    ...
    >
      ...
      >
        ...
        >
          ...
          <p>Selamat, Anda telah keluar dari anggota IDI cabang Jakarta Pusat.</p>
        </div>
        <div class="p-1">
          <div
          ...
          >
            ...
            <br>
            <br>
            Surat yang telah diupload telah diterima oleh Admin dan dijadikan sebagai arsip.
            <br>
            <br>
          ...
          >
            ...
            Silahkan lengkapi data yang diajukan, agar bisa di proses oleh Admin.
          </div>
          <hr>
          <div
...
export default {
  ...
  computed: {
    isHidePengajuan() {
      return (this.user?.data?.orang_level === 'jakpus' && this.mutasi.data?.[0].mutkeluar_status === 'selesai-sukses')
    },
    isHowAddPengajuan() {
      return this.mutasi.data?.[0] && this.mutasi.data?.[0].mutkeluar_status !== 'diajukan' && this.user?.data?.orang_level === 'jakpus'
    },
    fileMutasi() {
      return item => {
